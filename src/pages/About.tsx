      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            ...
            provided to us. Our unique process allows us to manufacture over
            1,500 different cartridges at tolerances up to 0.0005”. We
            manufacture reloading brass cartridges for any firearm, and if you
            are seeking quality products made in the USA, then you are at the
            right place. The draw process has been used for cartridge
            manufacturing since the 19th century and manufacturers have been
            able to develop this process to produce high volumes of brass cases.
            Draw cartridge manufactures have tested many different types of
            materials over the years and the best material for this process is a
            brass alloy with a mixture of 70% copper and 30% zinc. When brass is
            annealed at 250° C there is no visible change to the bonding of the
            grain structure, tensile strength, and elasticity. At 300° C, there
            is a microscopic change to the grain structure and at 350° the work
            hardness becomes softer and a fine grain structure can be seen. As
            temperatures increase the brass becomes fully annealed at 750° C and
            large crystals can be seen. Temperatures above this point will cause
            ...
            test is what you can do with RCC Brass™. We are proudly Made in the
            U.S.A.
          </Typography>
        </AccordionDetails>
      </Accordion>
